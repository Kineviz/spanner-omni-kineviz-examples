...
# database on the deployment: the other demo in this repo, and anything you
# built yourself. Removing it to clean up one demo would be destroying unrelated
# data to reclaim a few megabytes. Removing the container is your call too, and
